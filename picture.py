...
# Form implementation generated from reading ui file '本地图片识别.ui'
#
...
"}")
        ...
        self.labresult3 = QtWidgets.QLabel(self.centralwidget)
        self.labresult3.setObjectName("labresult3")
        self.gridLayout.addWidget(self.labresult3, 0, 0, 1, 1)
...
"}")
        ...
        self.btnopenfile.clicked.connect(MainWindow.btnopenpicture_Clicked)
        QtCore.QMetaObject.connectSlotsByName(MainWindow)

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "16小组口罩识别系统"))
        self.labresult3.setText(_translate("MainWindow", "                                 结 果 图 片"))
        self.btnopenfile.setText(_translate("MainWindow", "选 择 本 地 图 片"))
